...
- #154 [리팩토링, 보안, 데이터] X2 contract: user_auth uid/socialYN 제거 + user_id PK 승격 (Parallel Change contract)
  ...
  consumes: user_auth user_id 컬럼 (← #118), AuthGuard user_id 전환 (← #128), UserAuthService join/login (← #129), refresh (← #130), oauth (← #131), user_auth_provider (← #120), user_info user_id (← #119), post user_id (← #121), post_like user_id (← #122)
...
- 버그: #77, #89
- 리팩토링: #75, #76, #79, #85, #86, #118, #121, #122, #128, #129, #130, #154, #69, #70, #73
- 인프라: #75, #79, #133
- 데이터: #79, #117, #118, #119, #120, #121, #122, #123, #124, #154
- 보안: #78, #121, #122, #125, #126, #128, #130, #133, #134, #135, #136, #154
- 문서: #61
- 테스트: #61
